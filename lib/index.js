...
/**
 * @param  {string|object} params    The path to the resource to GET.
 ...
 */
JSZipUtils.getBinaryContent = function (params, options) {
    var path = params.url
    ...
    try {
        ...
        for (const property in params.httpHeaders) {
            const value = params.httpHeaders[property];
